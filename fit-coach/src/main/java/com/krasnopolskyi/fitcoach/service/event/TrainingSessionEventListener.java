...
//    private final Queue<AddTrainingSessionEvent> events = new LinkedList<>();
    ...
    @EventListener
    public void handleAddTrainingSessionEvent(TrainingSessionEvent event) {
        try {
...
//        Iterator<AddTrainingSessionEvent> iterator = events.iterator();
//        while (iterator.hasNext()) {
//            AddTrainingSessionEvent event = iterator.next();
//            try {
//                TrainingSessionDto trainingSessionDto = event.getTrainingSessionDto();
//                ResponseEntity<String> response = reportClient.saveTrainingSession(trainingSessionDto);
